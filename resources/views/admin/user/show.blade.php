                ...
                <div class="card-body ">
                    @if( isset($data))
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control @error('password') {{ 'is-invalid' }} @enderror" readonly placeholder="Senha" name="password" id="password">
                            @error('password')
                            <div id="nameFeedback" class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password_confirmation" class="form-control @error('password_confirmation') {{ 'is-invalid' }} @enderror" readonly placeholder="Confirmar Senha" id="password_confirmation">
